...
\begin{frame}{Split: \boxed{(H , A) \rightarrowtail (\bar{e} ,T, \bar{A}, A')}\footnote{Observation: we know that $\Gamma \vdash \boxed{e} \mapsto H \Rightarrow e \Rightarrow A \rightarrow B$ is always true, thus it covers all cases.}}
\begin{mathpar}
\inferrule*[lab=none]	
{ }
