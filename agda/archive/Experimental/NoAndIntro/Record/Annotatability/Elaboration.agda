...
annotatability-r (e-one-need {e = e} x x₁) = S.⊢r-one (S.⊢d-ann (⊢d-sub-∞ (annotatability x₁) (req-plusS⇒ e)))
...
annotatability-r (e-cons-need {e = e} x x₁ e-r neq) = S.⊢r-cons (S.⊢d-ann (⊢d-sub-∞ (annotatability x₁) (req-plusS⇒ e)))
