...
data Term where
  ...
  𝕣_       : Record → Term
  _𝕡_      : Term → Label → Term
  case_[inj₁⇒_|inj₂⇒_] : (e : Term) → (e₁ : Term) → (e₂ : Term) → Term
...
(𝕣 rs) ↑ n = 𝕣 (rs ↑r n)
(e 𝕡 l) ↑ n = (e ↑ n) 𝕡 l
case e [inj₁⇒ e₁ |inj₂⇒ e₂ ] ↑ n = case (e ↑ n) [inj₁⇒ e₁ ↑ (suc n) |inj₂⇒ e₂ ↑ (suc n) ]
...
↑-↓-id (case e [inj₁⇒ e₁ |inj₂⇒ e₂ ]) n rewrite ↑-↓-id e n | ↑-↓-id e₁ (suc n) | ↑-↓-id e₂ (suc n) = refl
...
↑-↑-comm case e [inj₁⇒ e₁ |inj₂⇒ e₂ ] m n m≤n rewrite ↑-↑-comm e m n m≤n
                                              | ↑-↑-comm e₁ (suc m) (suc n) (s≤s m≤n)
                                              | ↑-↑-comm e₂ (suc m) (suc n) (s≤s m≤n) = refl
...
↑-shifted {case e [inj₁⇒ e₁ |inj₂⇒ e₂ ]} {n} = sd-case ↑-shifted ↑-shifted ↑-shifted
...
↓-↑-comm case e [inj₁⇒ e₁ |inj₂⇒ e₂ ] m n m≤n (sd-case sd sd₁ sd₂) rewrite ↓-↑-comm e m n m≤n sd
                                              | ↓-↑-comm e₁ (suc m) (suc n) (s≤s m≤n) sd₁
                                              | ↓-↑-comm e₂ (suc m) (suc n) (s≤s m≤n) sd₂ = refl
...
↑-shifted-n {case e [inj₁⇒ e₁ |inj₂⇒ e₂ ]} m≤n+1 (sd-case sd sd₁ sd₂) = sd-case (↑-shifted-n m≤n+1 sd) (↑-shifted-n (s≤s m≤n+1) sd₁)
                                                                         (↑-shifted-n (s≤s m≤n+1) sd₂)
