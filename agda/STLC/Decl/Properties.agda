...
⊢d-weaken (⊢d-sub ⊢e A~j j≢Z) n≤l = ⊢d-sub (⊢d-weaken ⊢e n≤l) A~j j≢Z
...
⊢d-strengthen (⊢d-sub ⊢e A~j j≢Z) sd n≤l = ⊢d-sub (⊢d-strengthen ⊢e sd n≤l) A~j j≢Z
