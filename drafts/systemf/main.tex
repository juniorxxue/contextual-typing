...
{\Gamma \vdash \boxed{A} \leadsto H \Rightarrow e \Rightarrow B}
{\Gamma \vdash  H \Rightarrow e[A] \Rightarrow B}

\end{mathpar}

\subsection{Subtyping: $\boxed{\Psi \vdash A <: \Sigma \dashv \Psi' \rightsquigarrow A}$}
...
{FV_{ex}(\Psi, A) = . }
{\Psi \vdash A <: \square \dashv \Psi \rightsquigarrow A}

\inferrule*[lab=S-Ex-L]
{FV_{ex}(\Psi, A) = . \\ \Psi \vdash A}
{\Psi \vdash \hat{a} <: A \dashv [A/\hat{a}]\Psi \rightsquigarrow A}

\inferrule*[lab=S-Ex-R]
{FV_{ex}(\Psi, A) = . \\ \Psi \vdash A}
{\Psi \vdash A <: \hat{a} \dashv [A/\hat{a}]\Psi \rightsquigarrow A}

\inferrule*[lab=S-Arr]
{\Psi \vdash C <: A \dashv \Delta_1 \rightsquigarrow A' \\
 \Delta_1 \vdash B <: D \dashv \Delta_2 \rightsquigarrow D'}
{\Psi \vdash A \rightarrow B <: C \rightarrow D \dashv \Delta_2 \rightsquigarrow A' \rightarrow D'}

\inferrule*[lab=S-Hole-No-Ex]
{ FV_{ex}(\Psi, A) = \emptyset \\
\Gamma \vdash A \Rightarrow e \Rightarrow C\\
 \Psi \vdash B <: H \dashv \Delta \rightsquigarrow D}
{\Psi \vdash A \rightarrow B <: \boxed{e} \rightarrow H \dashv \Delta \rightsquigarrow A \rightarrow D}
...
{\Psi \vdash A \rightarrow B <: \boxed{e} \rightarrow H \dashv \Delta_2 \rightsquigarrow A' \rightarrow D}

\inferrule*[lab=S-All]
{\Psi, a \vdash A <: B \dashv \Delta_1, a\rightsquigarrow C}
{\Psi \vdash \forall a. A <: \forall a. B \dashv \Delta_1 \rightsquigarrow \forall a. C}

\inferrule*[lab=S-All-L]
{\Psi, \hat{a} \vdash [\hat{a}/a]A <: \boxed{e} \rightarrow H \dashv \Delta_1, \hat{a} \rightsquigarrow B}
{\Psi \vdash \forall a. A <: \boxed{e} \rightarrow H \dashv \Delta_1 \rightsquigarrow B}
\end{mathpar}
\end{document}