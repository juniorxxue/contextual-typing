...
{ \Psi \vdash_{close} A \\
 \Psi \vdash_{close} B \\
\| \Psi \| \vdash A \Rightarrow e \Rightarrow A'\\
...
\begin{itemize}
	\item The existential variables will never appear in the context position (right side of the subtyping)
  (edits: this is obviously wrong, many cases need existential at the right side, but I have't found cases need ex in the left?)
