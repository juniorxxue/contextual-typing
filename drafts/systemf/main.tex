...
{\Gamma, a \vdash A \Rightarrow e \Rightarrow B}
{\Gamma \vdash \forall a.~A \Rightarrow \Lambda a.~e \Rightarrow \forall a.~B}
...
\subsection{Subtyping(Undrafted)}

\begin{mathpar}
\inferrule*[lab=S-Int]
{ }
{\Gamma \vdash \mathtt{Int} <: \mathtt{Int} \rightsquigarrow \mathtt{Int}}

\inferrule*[lab=S-Top]
{ }
{\Gamma \vdash A <: \mathtt{Top} \rightsquigarrow A}
