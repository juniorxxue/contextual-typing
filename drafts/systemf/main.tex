...
\begin{mathpar}
    ...
    {\hat{a} = B \in \Gamma \\ \Gamma \vdash B <: A}
    {\Gamma \vdash_n \hat{a} <: A}
    
        \inferrule*[lab=S-var-r]
    {\hat{a} = B \in \Gamma \\ \Gamma \vdash A <: B}
...
\inferrule*[lab=S-Empty]
{FV_{ex}(\Gamma, A) = .}
{\Gamma \vdash A <: \square \dashv \Gamma \rightsquigarrow \Gamma(A)}
...
\inferrule*[lab=S-All]
{\Gamma, o \vdash A <: B \dashv \Gamma', o\rightsquigarrow C}
