...
\inferrule*[lab=T-Lit]
{ }
{\Gamma \vdash \mathtt{Top} \Rightarrow i \Rightarrow \mathsf{Int}}

\inferrule*[lab=T-Var]
{x : A \in \Gamma}
{\Gamma \vdash \mathtt{Top} \Rightarrow x \Rightarrow A}

\inferrule*[lab=T-Ann]
{\Gamma \vdash A \Rightarrow e \Rightarrow B}
{\Gamma \vdash \mathtt{Top} \Rightarrow e : A \Rightarrow A}

\inferrule*[lab=T-TAbs]
{\Gamma, a \vdash \mathtt{Top} \Rightarrow e \Rightarrow A}
{\Gamma \vdash \mathtt{Top} \Rightarrow \Lambda a.~e \Rightarrow \forall a.~A}
...
{\Gamma \vdash \mathtt{Top} \Rightarrow e_2 \Rightarrow A\\
...
{FV_{ex}(A) = . \\ \Gamma_1 \vdash A}
{\Gamma_1, \hat{a}, \Gamma_2 \vdash \hat{a} <: A \dashv \Gamma_1, \hat{a} := A, \Gamma_2 \rightsquigarrow A}

\inferrule*[lab=S-Ex-R]
{FV_{ex}(A) = . \\ \Gamma_1 \vdash A}
{\Gamma_1, \hat{a}, \Gamma_2 \vdash A <: \hat{a} \dashv \Gamma_1, \hat{a} := A, \Gamma_2 \rightsquigarrow A}
...
\inferrule*[lab=S-Inst]
{FV_{ex}(A) = s \\ s != . \\
    \Gamma \vdash Top \Rightarrow e \Rightarrow C \\
    \Gamma \vdash C <: A \dashv \Delta \rightsquigarrow A' \\
    \Delta/s \vdash B/s <: H \dashv \Delta/s \rightsquigarrow D}
{\Gamma \vdash A \rightarrow B <: \boxed{e} \rightarrow H \dashv \Delta/s \rightsquigarrow A' \rightarrow D}
...
{\Gamma, \hat{a} \vdash [\hat{a}/a]A <: \boxed{e} \rightarrow H \dashv \Delta \rightsquigarrow B}
{\Gamma \vdash \forall a. A <: \boxed{e} \rightarrow H \dashv \Delta \rightsquigarrow B}
